...
import { getConsoleLearningCycle, getConsoleLatestLearningCycle, listConsoleLearningCycles, listConsoleLearningAttention } from './handlers/consoleLearningCycles.js';
...
import { getConsoleResultEvolutionInspection, postConsoleEvolutionProposal, getConsoleEvolutionProposal, postConsoleEvolutionApprove, postConsoleEvolutionReject, getConsoleEvolutionPolicy, putConsoleEvolutionPolicy, postConsoleEvolutionAnalyze, postConsoleEvolutionVerifyOutcome, postConsoleHumanRequestRepair } from './handlers/consoleTestEvolution.js';
import {
  ...
  postInternalRunnerMutationCompleted,
  postInternalRunnerMutationUnknown,
  postInternalRunnerMutationFailedBeforeDispatch,
...
const gatewayRouteHandlers = {
  ...
  internalRunnerMutationDispatchingPost: async (req, env, _ctx, params) => json(await postInternalRunnerMutationDispatching(req, env, params), { headers: corsHeaders(req, env) }),
  internalRunnerMutationResponseReceivedPost: async (req, env, _ctx, params) => json(await postInternalRunnerMutationResponseReceived(req, env, params), { headers: corsHeaders(req, env) }),
  internalRunnerMutationCompletedPost: async (req, env, _ctx, params) => json(await postInternalRunnerMutationCompleted(req, env, params), { headers: corsHeaders(req, env) }),
  internalRunnerMutationUnknownPost: async (req, env, _ctx, params) => json(await postInternalRunnerMutationUnknown(req, env, params), { headers: corsHeaders(req, env) }),
  internalRunnerMutationFailedBeforeDispatchPost: async (req, env, _ctx, params) => json(await postInternalRunnerMutationFailedBeforeDispatch(req, env, params), { headers: corsHeaders(req, env) }),
  ...
  consoleLatestLearningCycleGet: async (req, env, _ctx, params) => json(await getConsoleLatestLearningCycle(req, env, params), { headers: corsHeaders(req, env) }),
  ...
  consoleEvolutionVerifyOutcomePost: async (req, env, _ctx, params) => json(await postConsoleEvolutionVerifyOutcome(req, env, params), { headers: corsHeaders(req, env) }),
  consoleHumanRequestRepairPost: async (req, env, _ctx, params) => json(await postConsoleHumanRequestRepair(req, env, params), { status: 201, headers: corsHeaders(req, env) }),
