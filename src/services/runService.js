...
function safeRunEnvelope(bundle, { idempotentReplay = false } = {}) {
  ...
  return {
    ...
    run: {
      ...
      purpose: plan?.plan?.purpose || plan?.purpose || 'REGRESSION',
    ...
    executionAttempt: bundle?.latestAttempt ? {
      ...
      authRuntimeStatus: bundle.latestAttempt.authRuntimeStatus || null,
      authRequiredScenarioCount: bundle.latestAttempt.authRequiredScenarioCount == null ? null : Number(bundle.latestAttempt.authRequiredScenarioCount),
      authResolvedProfileCount: bundle.latestAttempt.authResolvedProfileCount == null ? null : Number(bundle.latestAttempt.authResolvedProfileCount),
      authDynamicExchangeCount: bundle.latestAttempt.authDynamicExchangeCount == null ? null : Number(bundle.latestAttempt.authDynamicExchangeCount),
      authCacheHitCount: bundle.latestAttempt.authCacheHitCount == null ? null : Number(bundle.latestAttempt.authCacheHitCount),
      authDurationMs: bundle.latestAttempt.authDurationMs == null ? null : Number(bundle.latestAttempt.authDurationMs),
      authResolvedAt: bundle.latestAttempt.authResolvedAt || null,
      testDataRuntimeStatus: bundle.latestAttempt.testDataRuntimeStatus || null,
      testDataBindingCount: bundle.latestAttempt.testDataBindingCount == null ? null : Number(bundle.latestAttempt.testDataBindingCount),
      testDataGeneratedCount: bundle.latestAttempt.testDataGeneratedCount == null ? null : Number(bundle.latestAttempt.testDataGeneratedCount),
      testDataFixedCount: bundle.latestAttempt.testDataFixedCount == null ? null : Number(bundle.latestAttempt.testDataFixedCount),
      testDataSecretCount: bundle.latestAttempt.testDataSecretCount == null ? null : Number(bundle.latestAttempt.testDataSecretCount),
      testDataDurationMs: bundle.latestAttempt.testDataDurationMs == null ? null : Number(bundle.latestAttempt.testDataDurationMs),
      testDataResolvedAt: bundle.latestAttempt.testDataResolvedAt || null,
      ...
      assertionExecutionStatus: bundle.latestAttempt.assertionExecutionStatus || null,
      assertionOutcome: bundle.latestAttempt.assertionOutcome || null,
      assertionScenarioCount: bundle.latestAttempt.assertionScenarioCount == null ? null : Number(bundle.latestAttempt.assertionScenarioCount),
      assertionScenarioPassedCount: bundle.latestAttempt.assertionScenarioPassedCount == null ? null : Number(bundle.latestAttempt.assertionScenarioPassedCount),
      assertionScenarioFailedCount: bundle.latestAttempt.assertionScenarioFailedCount == null ? null : Number(bundle.latestAttempt.assertionScenarioFailedCount),
      assertionScenarioNotEvaluatedCount: bundle.latestAttempt.assertionScenarioNotEvaluatedCount == null ? null : Number(bundle.latestAttempt.assertionScenarioNotEvaluatedCount),
      assertionCount: bundle.latestAttempt.assertionCount == null ? null : Number(bundle.latestAttempt.assertionCount),
      assertionPassedCount: bundle.latestAttempt.assertionPassedCount == null ? null : Number(bundle.latestAttempt.assertionPassedCount),
      assertionFailedCount: bundle.latestAttempt.assertionFailedCount == null ? null : Number(bundle.latestAttempt.assertionFailedCount),
      assertionNotEvaluatedCount: bundle.latestAttempt.assertionNotEvaluatedCount == null ? null : Number(bundle.latestAttempt.assertionNotEvaluatedCount),
      assertionDurationMs: bundle.latestAttempt.assertionDurationMs == null ? null : Number(bundle.latestAttempt.assertionDurationMs),
      assertionEvaluatedAt: bundle.latestAttempt.assertionEvaluatedAt || null,
      assertionDiagnostic: bundle.latestAttempt.assertionPrimaryDiagnosticKind ? {
        kind: bundle.latestAttempt.assertionPrimaryDiagnosticKind,
        scenarioId: bundle.latestAttempt.assertionPrimaryScenarioId || null,
        assertionIndex: bundle.latestAttempt.assertionPrimaryIndex == null ? null : Number(bundle.latestAttempt.assertionPrimaryIndex),
        assertionType: bundle.latestAttempt.assertionPrimaryType || null,
        errorCode: bundle.latestAttempt.assertionPrimaryErrorCode || null,
        path: bundle.latestAttempt.assertionPrimaryPath || null,
        headerName: bundle.latestAttempt.assertionPrimaryHeaderName || null,
        schemaRef: bundle.latestAttempt.assertionPrimarySchemaRef || null,
        actualStatusCode: bundle.latestAttempt.assertionPrimaryActualStatusCode == null ? null : Number(bundle.latestAttempt.assertionPrimaryActualStatusCode),
        actualContentType: bundle.latestAttempt.assertionPrimaryActualContentType || null,
      } : null,
    } : null,
    idempotentReplay,
  };
