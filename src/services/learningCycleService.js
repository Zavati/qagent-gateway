...
function stateForVerification(outcome){
  if(['HYPOTHESIS_VERIFIED','COVERAGE_VERIFIED','REQUEST_REPAIR_VERIFIED'].includes(outcome))return 'HEALTHY';
  if(['HYPOTHESIS_NOT_VERIFIED','COVERAGE_NOT_VERIFIED','REQUEST_REPAIR_NOT_VERIFIED'].includes(outcome))return 'REVIEW_REQUIRED';
